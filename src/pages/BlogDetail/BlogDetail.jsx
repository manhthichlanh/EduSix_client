        ...
        <div className="grid grid-cols-12 gap-6 px-10 lg:px-20 md:px-16 sm:px-10">
            <div className="col-span-12">
                ...
                <div className="flex flex-col justify-between items-center gap-4">
                    ...
                    <p className='text-[36px] font-semibold'>Cách chỉnh theme Oh-my-posh cho Powershell</p>
                    <div className="flex gap-4 items-center">
                ...
                <div className="py-10">
                    <p className='text-[16px]'>Nội dung ở đây. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magni maiores nam consequatur corporis consectetur repellendus deleniti vel perspiciatis molestias dolore dolores eos dolorem voluptate possimus ut tempore, minus cumque? Amet!</p>
                </div>
            </div>
        </div>
    );
